...
#define POST_REQUEST_URI 	"/posts"
#define POST_DATA           "{\n\"name\":\"xyz\",\n\"address\":\n{\n\"plot#\":12,\n\"street\":\"abc\",\n\"city\":\"ijk\"\n},\n\"age\":30\n}"

#define DELETE_REQUEST_URI 	"/posts/1"


#define PUT_REQUEST_URI 	"/posts/1"
#define PUT_DATA            "PUT request."

#define GET_REQUEST_URI 	"/posts/1"


#define HOST_NAME       	"jsonplaceholder.typicode.com" //"<host name>"
#define HOST_PORT           80
...
int main()
{
    ...
    //
    lRetVal = osi_TaskCreate(HttpClientTask, (const signed char *)"Http Client",
